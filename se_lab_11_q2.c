 ...
 *
 * 1. Shubham Paul      (Roll No. - 002011001071)
 * 2. Sayan Maji        (Roll No. - 002011001079)
 * 3. Koushik Mahanta   (Roll No. - 002011001106)
 * 4. Soumyadeep Pal    (Roll No. - 002011001113)
 */
...
/*
 * Compilation command :    gcc -o se_lab_11_q2 se_lab_11_q2.c
 * Execution sequence  :    ./se_lab_11_q2
 */
...
int main()
{
        ...
        // opening files
        secretFile = fopen("Secret_info11.txt","rb");    // contains secret information
        matrixFile = fopen("256x256_cover4.txt","rb");  // contains the original matrix
        newMatrixFile = fopen("newMatrix2.pgm","wb");   // contains the modified matrix
