    ...
    def toss(self):
        ...
        for i in range(0,(2**self.numberOfToss)*int(sys.argv[3])):
            ...
            for j in range(0,self.numberOfToss):
                ...
                #this checks if result is present in the list if it is present status is set to 1 otherwise 0. For example if the second argument is 3/5 then the following list contains [0,1,2] now if the result of the random number generator is one of this three then status = 1 otherwise status = 0
