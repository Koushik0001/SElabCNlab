...
/*
 * Compilation command :    gcc -o se_lab_11_q1 se_lab_11_q1.c
 * Execution sequence  :    ./se_lab_11_q1
 */
...
int main()
{
        ...
        // opening files
        secretFile = fopen("Secret_info4.txt","rb");    // contains secret information
        matrixFile = fopen("256x256_cover4.txt","rb");  // contains the original matrix
        newMatrixFile = fopen("newMatrix1.pgm","wb");   // contains the modified matrix
